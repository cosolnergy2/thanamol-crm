  ...
  return [
    ...
    },
    {
      ...
      submenu: [
        ...
        { label: t.bankReconciliation, path: '/finance/banking/reconciliations' },
        { label: t.withholdingTax, path: '/finance/tax/withholding-tax' },
        { label: t.taxDashboard, path: '/finance/tax/dashboard' },
        { label: t.apInvoices, path: '/finance/ap/invoices' },
        { label: t.apAging, path: '/finance/ap/aging' },
        { label: t.paymentVouchers, path: '/finance/ap/payment-vouchers' },
        { label: t.fixedAssetRegister, path: '/finance/fixed-assets/register' },
        { label: t.depreciationPosting, path: '/finance/fixed-assets/depreciation' },
        { label: t.assetDisposals, path: '/finance/fixed-assets/disposals' },
        { label: t.assetTransfers, path: '/finance/fixed-assets/transfers' },
        { label: t.cfoDashboard, path: '/finance/executive/cfo-dashboard' },
        { label: t.cashFlowAnalysis, path: '/finance/executive/cash-flow' },
      ],
    },
    {
      label: t.utilities,
    ...
    },
    {
      ...
      submenu: [
        ...
        { label: 'Stock Transfers', path: '/facility-management/inventory/transfers' },
        { label: 'Goods Received', path: '/facility-management/inventory/grn' },
        { label: 'Reorder Alerts', path: '/facility-management/inventory/reorder-alerts' },
        ...
        { label: 'Quotation Compare', path: '/facility-management/procurement/quotations/compare' },
    ...
    },
    {
      ...
      submenu: [
        ...
        { label: 'Landscape', path: '/facility-management/landscape' },
        { label: 'Waste Records', path: '/facility-management/waste' },
        ...
        { label: 'Budget Overview', path: '/facility-management/budget/overview' },
        { label: 'Budget Reports', path: '/facility-management/budget/reports' },
        ...
        { label: 'Disaster Plans', path: '/facility-management/emergency/plans' },
        { label: 'Emergency Drills', path: '/facility-management/emergency/drills' },
        { label: 'Helpdesk', path: '/facility-management/helpdesk' },
        { label: 'Meters', path: '/facility-management/meters' },
        { label: 'Meter Rates', path: '/facility-management/meters/rates' },
