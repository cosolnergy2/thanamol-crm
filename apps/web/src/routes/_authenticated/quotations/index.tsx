                ...
                quotations.map((quotation) => (
                  ...
                  >
                    ...
                    <TableCell className="py-3">
                      <Badge
                        variant="outline"
                        className={`${STATUS_COLORS[quotation.status] ?? ''} text-[9px] h-4 px-1.5 font-extralight`}
                      >
                        {quotation.status}
                      </Badge>
                    </TableCell>
                    <TableCell className="py-3">
                      <div className="flex items-center gap-1">
                        {quotation.status === 'DRAFT' && (
                          <Link to="/quotations/$quotationId/edit" params={{ quotationId: quotation.id }}>
                            <Button size="sm" variant="ghost" className="h-7 w-7 p-0">
                              <Edit className="w-3.5 h-3.5" />
                            </Button>
                          </Link>
                        )}
                        <Link to="/quotations/$quotationId" params={{ quotationId: quotation.id }}>
                          <Button size="sm" variant="ghost" className="h-7 w-7 p-0">
