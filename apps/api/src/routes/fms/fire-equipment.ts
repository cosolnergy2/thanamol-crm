...
const createFireEquipmentSchema = t.Object({
  ...
  capacitySize: t.Optional(t.String()),
  installationDate: t.Optional(t.String()),
  condition: t.Optional(t.String()),
  certificationNumber: t.Optional(t.String()),
          ...
          async ({ body, set }) => {
            const equipment = await prisma.fireEquipment.create({
              data: {
                ...
                capacity_size: body.capacitySize ?? null,
                installation_date: body.installationDate ? new Date(body.installationDate) : null,
                condition: body.condition ?? null,
                certification_number: body.certificationNumber ?? null,
          ...
          async ({ params, body, set }) => {
            ...
            const equipment = await prisma.fireEquipment.update({
              ...
              data: {
                ...
                ...(body.serialNumber !== undefined && { serial_number: body.serialNumber ?? null }),
                ...(body.capacitySize !== undefined && { capacity_size: body.capacitySize ?? null }),
                ...(body.installationDate !== undefined && {
                  installation_date: body.installationDate ? new Date(body.installationDate) : null,
                }),
