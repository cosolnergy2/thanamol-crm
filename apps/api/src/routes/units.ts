...
const createUnitSchema = t.Object({
  ...
  zoneLegacy: t.Optional(t.String()),
  zoneId: t.Optional(t.String()),
  location: t.Optional(t.String()),
  officeAreaSqm: t.Optional(t.Number({ minimum: 0 })),
  floorLoad: t.Optional(t.String()),
  electricalLoad: t.Optional(t.String()),
  ceilingHeight: t.Optional(t.Number({ minimum: 0 })),
  leaseType: t.Optional(t.String()),
  floorPlanUrl: t.Optional(t.String()),
  hasSprinkler: t.Optional(t.Boolean()),
  rentPerSqm: t.Optional(t.Number({ minimum: 0 })),
  commonFee: t.Optional(t.Number({ minimum: 0 })),
  commonFeeWaived: t.Optional(t.Boolean()),
  waterRate: t.Optional(t.Number({ minimum: 0 })),
  waterRateActual: t.Optional(t.Boolean()),
  electricityRate: t.Optional(t.Number({ minimum: 0 })),
  electricityRateActual: t.Optional(t.Boolean()),
  depositMonths: t.Optional(t.Integer({ minimum: 0 })),
  advanceRentMonths: t.Optional(t.Integer({ minimum: 0 })),
})
          ...
          async ({ body, authUser, headers, set }) => {
            ...
            const unit = await prisma.unit.create({
              data: {
                ...
                zone_legacy: body.zoneLegacy,
                zone_id: body.zoneId,
                location: body.location,
                office_area_sqm: body.officeAreaSqm,
                floor_load: body.floorLoad,
                electrical_load: body.electricalLoad,
                ceiling_height: body.ceilingHeight,
                lease_type: body.leaseType,
                floor_plan_url: body.floorPlanUrl,
                has_sprinkler: body.hasSprinkler ?? false,
                rent_per_sqm: body.rentPerSqm,
                common_fee: body.commonFee,
                common_fee_waived: body.commonFeeWaived ?? false,
                water_rate: body.waterRate,
                water_rate_actual: body.waterRateActual ?? false,
                electricity_rate: body.electricityRate,
                electricity_rate_actual: body.electricityRateActual ?? false,
          ...
          async ({ params, body, authUser, headers, set }) => {
            ...
            const unit = await prisma.unit.update({
              ...
              data: {
                ...
                lease_type: body.leaseType,
                floor_plan_url: body.floorPlanUrl,
                has_sprinkler: body.hasSprinkler,
                rent_per_sqm: body.rentPerSqm,
                common_fee: body.commonFee,
                common_fee_waived: body.commonFeeWaived,
                water_rate: body.waterRate,
                water_rate_actual: body.waterRateActual,
                electricity_rate: body.electricityRate,
                electricity_rate_actual: body.electricityRateActual,
                deposit_months: body.depositMonths,
                advance_rent_months: body.advanceRentMonths,
              },
              include: { project: { select: { id: true, name: true, code: true } } },
